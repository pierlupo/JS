...
boutons.forEach(function(bouton){
    ...
    bouton.addEventListener("click", function(){
		// je regarde si la valeur de mon bouton est inférieure à 1 et donc à un chiffre.
		if(this.value <10){
			// je mets mon chiffre à la suite de mes nombres.
			total += this.value;
        }
		...
		// sinon si c'est le bouton d'effacement.
